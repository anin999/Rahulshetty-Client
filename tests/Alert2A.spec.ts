...
test('Verify JavaScript Confirm Alert - OK Button', async ({ page }) => {
    ...
    page.once('dialog', async dialog => {
        ...
        console.log('Verify that user can click OK button');
        await dialog.accept();

        console.log('Verify that user clicks ok button');
        console.log('=================================\n');

    });

    console.log('Verify that user clicks - OK - JS confirm button');
    ...
    console.log('Verify that results shows : You clicked: Ok');
    await delay();
